...
def titledata():
    ...
    response_data = {
        ...
        "BundleBoardSign": "<color=#ff4141>discord.gg/str3cMBsMs</color>",
        "BundleKioskButton": "<color=#ff4141>discord.gg/str3cMBsMs</color>",
        "BundleKioskSign": "<color=#ff4141>discord.gg/str3cMBsMs/</color>",
        "BundleLargeSign": "<color=#ff4141>discord.gg/str3cMBsMs</color>",
        ...
        "MOTD": "<color=orange>WELCOME TO NATIVE TAG</color>  <color=green>OWNERS ARE : TALKING BEN AND QUEST!</color>  <color=red>TALKING HANK IS TUFF</color>  <color=red>JOIN THE DISC!</color>  <color=yellow>IF YOU ENJOY THE GAME, PLEASE GIVE IT  (5 STARS)!</color> <color=yellow>discord.gg/str3cMBsMs</color>",
        "SeasonalStoreBoardSign": "<color=#ff7241>FALL!</color>",
        "TOS_2024.09.20": "discord.gg/VKFuNbHvtH",
        "TOBAlreadyOwnCompTxt": "discord.gg/str3cMBsMs",
        "TOBAlreadyOwnPurchaseBundle": "BLABLABLA",
        "TOBDefCompTxt": "discord.gg/str3cMBsMs",
