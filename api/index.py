...
class GameInfo:
    def __init__(self) -> None:
        ...
        self.MothershipJwtSecret: str = " uigsduifgasiudgyiusdfgf8sdgtfd97gsd978sdgfgsdfuifgsiudfgiusdfgiusdgfiusgdiugsidgf"  # Set this to a long random secret string
...
FailedAuthy = "https://discord.com/api/webhooks/1543555244015886358/dGTafN4Q-lhe3_IcLwEFoc6ZkY37HzHU0QX6HlfokXZGFaSztpDSnDt-Sw_9OinEjoCi"
...
def titledata():
    ...
    response_data = {
        ...
        "BundleBoardSign": "<color=#ff4141>discord.gg/gtY8NSa8uC</color>",
        "BundleKioskButton": "<color=#ff4141>discord.gg/gtY8NSa8uC</color>",
        "BundleKioskSign": "<color=#ff4141>discord.gg/gtY8NSa8uC/</color>",
        "BundleLargeSign": "<color=#ff4141>discord.gg/gtY8NSa8uC</color>",
        ...
        "MOTD": "<color=orange>WELCOME TO NATIVE TAG</color>  <color=green>THE FOUNDERS ARE : HARMONY & YUKI!</color>  <color=red>RATE THE GAME 5 STARS AND MAKE A TICKET FOR COSMETICS</color>  <color=red>GAME IS A BIT MODDED AT THE MOMENT!</color>  <color=white>JOIN THE DISCORD PLEASE!</color> <color=red>discord.gg/gtY8NSa8uC</color>",
        "SeasonalStoreBoardSign": "<color=#ff7241>HALLOWEEN 2023 - FLASHBACK!</color>",
        "TOS_2024.09.20": "discord.gg/gtY8NSa8uC",
        "TOBAlreadyOwnCompTxt": "discord.gg/gtY8NSa8uC",
        "TOBAlreadyOwnPurchaseBundle": "BLABLABLA",
        "TOBDefCompTxt": "discord.gg/gtY8NSa8uC",
...
if __name__ == "__main__":
    app.run("0.0.0.0", 8080) # discord.gg/gtY8NSa8uC
