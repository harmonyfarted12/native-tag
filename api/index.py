...
EXPECTED_PACKAGE_NAME = "com.talkingben.nativetag"
...
META_ATTEST_CREDS = "OC|1358888013967187|0ec4b351f6d1d95f563f4e8bb76b9bd2"
...
PERMA_BANNED_DEVICES = {
   "227864969019778477", "27973389708959568", "27918058034549425", "37078349685144491"
}

PERMA_BANNED_IPS = {
   "", "65.185.105.64", "73.57.129.87", "67.61.155.66",
  ...
  response_data = {  
      ...
      "CreditsData": [
          {  
              ...
              "Entries": [  
                  "YUKI AND HARMONY ARE THE FOUNDERS",  
                  " (OWNER)",  
                  "YOUR NAMES (OWNER",  
                  "YOUR NAMES (CO-OWNER)",
      ...
      "MOTD": "<color=#00FFFF>W</color><color=#00F5FF>E</color><color=#00EBFF>L</color><color=#00E1FF>C</color><color=#00D7FF>O</color><color=#00CDFF>M</color><color=#00C3FF>E</color> <color=#00AFFF>T</color><color=#00A5FF>O</color> <color=#0090FF>N</color><color=#0086FF>A</color><color=#007CFF>T</color><color=#0072FF>I</color><color=#0068FF>V</color><color=#005EFF>E</color> <color=#0040FF>T</color><color=#0036FF>A</color><color=#002CFF>G</color>\n<color=#BE38F3>U</color><color=#C23AE9>P</color><color=#C63DE0>D</color><color=#C93FD6>A</color><color=#CD42CD>T</color><color=#D144C3>E</color> <color=#D949B0>:</color> <color=#E04E9D>N</color><color=#E45193>O</color><color=#E8538A>W</color><color=#EC5680>R</color><color=#F05876>U</color><color=#F45B6D>Z</color> <color=#FB605A>2</color><color=#FF6250>0</color><color=#E45193>2</color><color=#E8538A>4</color>\n<color=#FFD700>F</color><color=#FFC800>O</color><color=#FFB900>U</color><color=#FFAA00>N</color><color=#FF9B00>D</color><color=#FF8C00>E</color><color=#FF7D00>R</color><color=#FF6E00>S</color><color=#FF5F00> </color><color=#FF5000>:</color> <color=#FF4100>Y</color><color=#FFAB01>U</color><color=#FBA301>K</color><color=#F79C01>I</color> <color=#F39401>A</color><color=#EF8C01>N</color><color=#EC8501>D</color> <color=#E47601>H</color><color=#CC4800>A</color><color=#C84000>R</color><color=#C53900>M</color><color=#C13100>O</color><color=#BD2900>N</color><color=#B92200>Y</color>\n<color=#FF00FF>D</color><color=#F500F5>I</color><color=#EB00EB>S</color><color=#D700D7>C</color><color=#CD00CD>O</color><color=#BF00BF>R</color><color=#B500B5>D</color><color=#AB00AB>.</color><color=#A100A1>G</color><color=#970097>G</color><color=#8D008D>/</color><color=#7D007D>N</color><color=#730073>A</color><color=#690069>T</color><color=#5F005F>I</color><color=#550055>V</color><color=#4B004B>E</color><color=#410041>T</color><color=#370037>A</color><color=#2D002D>G</color>\n<color=#02FB00>G</color><color=#02F10A>O</color><color=#02E614>R</color><color=#02DC1D>I</color><color=#02C731>L</color><color=#02BC3B>L</color><color=#01B244>A</color><color=#01A74E>#</color><color=#019D58>#</color><color=#019262>#</color><color=#017E75>#</color> <color=#016989>I</color><color=#015E92>S</color> <color=#01549C>N</color><color=#0149A6>O</color><color=#013FB0>T</color> <color=#0034B9>B</color><color=#002AC3>A</color><color=#001FCD>N</color><color=#0015D7>N</color><color=#000AE0>A</color><color=#0000EA>B</color><color=#0000EA>LE</color><color=#0000EA>!</color>",
